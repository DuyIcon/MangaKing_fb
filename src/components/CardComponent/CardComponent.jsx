    ...
    <div>
       <Card 
        ...
        <div>
            ...
            <WrapperReportText>
                <span>{rating}</span><StarFilled style={{fontSize:'10px', color:'#e68a00', marginLeft:'2px'}}/>
                <WrapperStyleTextSell style={{marginLeft:'5px'}}> | {selled || 1000}+ sold</WrapperStyleTextSell>
            </WrapperReportText>
            ...
            <div>
                <StyleSalePercentProduct StyleSalePercentProduct>- {discount || 10}%</StyleSalePercentProduct>
            </div>
        </div>
