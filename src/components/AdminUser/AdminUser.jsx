...
const AdminUser = () => {
  ...
  const renderAction = () => {
    return (
      <div>
        ...
        <EditOutlined style={{color: 'orange', fontSize: '30px', cursor: 'pointer'}} onClick={handleDetailsUser}></EditOutlined>
      </div>
    )
  }
 ...
 const handleCancelDelete = () => {
  ...
  /**
   * 
   * @param {import('antd/es/upload').UploadChangeParam} fileList 
   */
