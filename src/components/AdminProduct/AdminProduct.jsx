  ...
  const renderAction = () => {
    return (
      <div>
        ...
        <EditOutlined style={{color: 'orange', fontSize: '30px', cursor: 'pointer'}} onClick={handleDetailsProduct}></EditOutlined>
      </div>
    )
  }
  ...
  return (
    <div>
        ...
        <div style={{marginTop:'25px'}}>
            <Button style={{height:'50px', width:'50px', borderRadius:'7px'}} onClick={() => setIsModalOpen(true)}><PlusOutlined style={{fontSize:'12px'}}/></Button>
        </div>
        <div style={{marginTop:'25px'}}>
      ...
      onClick: event => {
        ...
        >
          ...
          >
            ...
            <WrapperUploadFile  maxCount={1} onChange={handleOnchangeAvatar} beforeUpload={() => false} >
              <Button>
            Upload File
              </Button>
                {stateProduct?.image && (
        ...
        <Loading isLoading={ isLoadingUpdate || isLoadingUpdated}>
          ...
          >
            ...
            >
              <WrapperUploadFile  maxCount={1} onChange={handleOnchangeAvatarDetails} beforeUpload={() => false} >
              <Button>
            Upload File
              </Button>
