...
import { decreaseAmount, increaseAmount, removeAllOrderProduct, removeOrderProduct, selectedOrder } from '../../redux/sildes/orderSlide';
...
const OrderPage = () => {
  ...
  const handleUpdateInforUser = () => {
    ...
    if (name && address && city && phone) {
      mutationUpdate.mutate({ ...stateUserDetails, id: user?.id, token: user?.access_token, }, {
        onSuccess: () => {
          console.log(user);
          dispatch(updateUser({ access_token: user.access_token, name, address, city, phone, _id: user.id}));
          setIsOpenModalUpdateInfo(false);
        }
      });
    }
